    ...
    <section className="post">
      ...
      <div className="tone">
        ...
        <div className="tone_select">
            ...
            <div>
                <p>Tone 2<span style={{ fontSize: '.8em', height: '15px', width: '15px', borderRadius: '50%', textAlign: 'center', backgroundColor: 'rgb(212, 209, 209)', cursor: 'pointer' }}>x</span></p>
            </div>
      ...
      <div className="tone">
        ...
        <div className="tone_select">
            ...
            <div>
                <p>Tone 5<span style={{ fontSize: '.8em', height: '15px', width: '15px', borderRadius: '50%', textAlign: 'center', backgroundColor: 'rgb(212, 209, 209)', cursor: 'pointer' }}>x</span></p>
            </div>
        </div>
